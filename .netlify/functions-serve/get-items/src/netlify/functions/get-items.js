...
var require_run_action = __commonJS({
  "node_modules/airtable/lib/run_action.js"(exports, module2) {
    ...
    function runAction(base, method, path, queryParams, bodyData, callback, numAttempts) {
      ...
      var isBrowser = typeof window !== "undefined";
      if (isBrowser) {
        headers2["x-airtable-user-agent"] = userAgent;
      } else {
  ...
  "node_modules/airtable/lib/base.js"(exports, module2) {
    ...
    var Base = function() {
      ...
      Base2.prototype.makeRequest = function(options) {
        ...
        var controller = new abort_controller_1.default();
        var headers2 = this._getRequestHeaders(Object.assign({}, this._airtable._customHeaders, (_a = options.headers) !== null && _a !== void 0 ? _a : {}));
        var requestOptions = {
          method,
          headers: headers2,
          signal: controller.signal
      ...
      Base2.prototype._getRequestHeaders = function(headers2) {
        var result = new http_headers_1.default();
        result.set("Authorization", "Bearer " + this._airtable._apiKey);
        result.set("User-Agent", userAgent);
        result.set("Content-Type", "application/json");
        for (var _i = 0, _a = keys_1.default(headers2); _i < _a.length; _i++) {
          var headerKey = _a[_i];
          result.set(headerKey, headers2[headerKey]);
        }
...
// netlify/functions/get-items.ts
__export(exports, {
  handler: () => handler
});
require_main().config();
...
var handler = async (event, context) => {
  var Airtable = require_airtable();
  Airtable.configure({
    apiKey: process.env.VITE_AIRTABLE_API_KEY
  });
  var base = Airtable.base("appswuXRTyToGWzD2");
  try {
    const records = await base("Gift Tracker").select({
      view: "Main view"
    }).firstPage();
    let response = [];
    records.forEach((rec) => {
